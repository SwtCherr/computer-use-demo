"""
Agentic sampling loop that calls the Nebius API and local implementation of computer use tools.
"""
...
from openai import AsyncOpenAI, APIStatusError, APIResponseValidationError, APIError
...
async def sampling_loop(
    *,
    ...
    while True:
        ...
        response_params = raw_response.parse().choices[0].message
        messages.append(
            {
                "role": "assistant",
        ...
        if response_params.content:
            output_callback({"type": "text", "text": response_params.content})
